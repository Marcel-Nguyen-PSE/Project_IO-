...
ggsave('Output/plot of demand and production norway.jpeg', plot = plot_demand_prod_nor, width = 6.5, height = 4, units = "in", dpi = 300)
...
tt_save(table_1_sum_stat_pre, 'Output/table1_sum_stat_pre.typ')
...
tt_save(table_1_sum_stat_post, 'Output/table1_sum_stat_post.typ')
...
tt_save(table_1_sum_stat_pool, 'Output/table1_sum_stat_pool.typ')
...
tt_save(tt(lag_results, rownames = FALSE), 'Output/tabel_price_auto.typ')
...
tt_save(tt(lag_results_byan, rownames = FALSE), 'Output/tabel_byan_auto.typ')
...
tt_save(tt(lag_results_qn, rownames = FALSE), 'Output/tabel_qn_auto.typ')
...
ggsave('Output/reg-price_qn.jpeg', plot = plot_reg_dem, width = 6.5, height = 4, units = "in", dpi = 300)
...
tt_save(diag_typst, "Output/iv_diagnostics_comparison.typ")
